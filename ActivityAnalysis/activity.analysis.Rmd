...
opts_chunk$set(echo = FALSE,
               warning = FALSE,
               message = FALSE,
               fig.path = 'figures/activity.analysis/',
               dev = c('png', 'pdf'),
               tidy = TRUE, 
